...
int main() {
    ...
    //PID pid = PID(0.25, 0, 0, false);
    //PID pid = PID(0.25, 0, 4, false);
    //PID pid = PID(0.25, 0, 4, true);
    //PID pid = PID(0.29477, 0, 3.558, true, true, false, true);
    PID pid = PID(0.315775, 0, 3.54665, false); // final params
